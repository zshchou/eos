...
extern "C" {
   ...
   void apply( unsigned long long code, unsigned long long action ) {
      ...
      // test vector
      WASM_TEST_HANDLER(test_vector, construct_all);
      WASM_TEST_HANDLER(test_vector, reserve);
      WASM_TEST_HANDLER(test_vector, assignment_operator);
      WASM_TEST_HANDLER(test_vector, index_operator);
      WASM_TEST_HANDLER(test_vector, index_out_of_bound);
      WASM_TEST_HANDLER(test_vector, destructor);
      WASM_TEST_HANDLER(test_vector, pod_type_general);
